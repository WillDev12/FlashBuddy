...
See [Setting Up the Scraper Server](setup-scraper-server) before using this method.
...
- If the import fails with a "Cards not found" error, try the [Print Page](import-cards-using-pdf) method instead.
